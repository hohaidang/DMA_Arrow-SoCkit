	soc_system u0 (
		...
		.ddr3_fpga_pll_sharing_pll_mem_clk               (<connected-to-ddr3_fpga_pll_sharing_pll_mem_clk>),               //     ddr3_fpga_pll_sharing.pll_mem_clk
		.ddr3_fpga_pll_sharing_pll_write_clk             (<connected-to-ddr3_fpga_pll_sharing_pll_write_clk>),             //                          .pll_write_clk
		.ddr3_fpga_pll_sharing_pll_locked                (<connected-to-ddr3_fpga_pll_sharing_pll_locked>),                //                          .pll_locked
		.ddr3_fpga_pll_sharing_pll_write_clk_pre_phy_clk (<connected-to-ddr3_fpga_pll_sharing_pll_write_clk_pre_phy_clk>), //                          .pll_write_clk_pre_phy_clk
		.ddr3_fpga_pll_sharing_pll_addr_cmd_clk          (<connected-to-ddr3_fpga_pll_sharing_pll_addr_cmd_clk>),          //                          .pll_addr_cmd_clk
		.ddr3_fpga_pll_sharing_pll_avl_clk               (<connected-to-ddr3_fpga_pll_sharing_pll_avl_clk>),               //                          .pll_avl_clk
		.ddr3_fpga_pll_sharing_pll_config_clk            (<connected-to-ddr3_fpga_pll_sharing_pll_config_clk>),            //                          .pll_config_clk
		.ddr3_fpga_pll_sharing_pll_mem_phy_clk           (<connected-to-ddr3_fpga_pll_sharing_pll_mem_phy_clk>),           //                          .pll_mem_phy_clk
		.ddr3_fpga_pll_sharing_afi_phy_clk               (<connected-to-ddr3_fpga_pll_sharing_afi_phy_clk>),               //                          .afi_phy_clk
		.ddr3_fpga_pll_sharing_pll_avl_phy_clk           (<connected-to-ddr3_fpga_pll_sharing_pll_avl_phy_clk>),           //                          .pll_avl_phy_clk
		.ddr3_fpga_status_local_init_done                (<connected-to-ddr3_fpga_status_local_init_done>),                //          ddr3_fpga_status.local_init_done
		.ddr3_fpga_status_local_cal_success              (<connected-to-ddr3_fpga_status_local_cal_success>),              //                          .local_cal_success
		.ddr3_fpga_status_local_cal_fail                 (<connected-to-ddr3_fpga_status_local_cal_fail>),                 //                          .local_cal_fail
		...
		.hps_0_hps_io_hps_io_gpio_inst_GPIO55            (<connected-to-hps_0_hps_io_hps_io_gpio_inst_GPIO55>),            //                          .hps_io_gpio_inst_GPIO55
		.hps_0_hps_io_hps_io_gpio_inst_GPIO56            (<connected-to-hps_0_hps_io_hps_io_gpio_inst_GPIO56>),            //                          .hps_io_gpio_inst_GPIO56
